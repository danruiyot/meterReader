...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($email_err) && empty($password_err)){
        ...
        $sql = "SELECT id, email, password FROM client WHERE email = ?";
...
<p>
<input type="submit" class="w3-btn w3-green" value="Login"></p>
<p>forget <a href="#" style="text-decoration:none;">password?</a></p>
